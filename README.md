...
See [Releases](https://github.com/focela/docker-alpine/releases) for a complete list of changes and updates.

## FAQ

**Q: Why use Alpine Linux as a base?**  
A: Alpine is lightweight, secure, and optimized for containers.
